...
public class DataLoader implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		c7.setCitizenName("Chalres");
		c7.setGender("Male");
		c7.setPlanName("Medical");
		c7.setPlanStatus("Approved");
		c7.setPlanStartDate(LocalDate.now());
		c7.setPlanEndDate(LocalDate.now().plusMonths(6));
		c7.setBenifitAmount(6000.00);
		
		//Food Data
		CitizenPlan c8=new CitizenPlan();
		c8.setCitizenName("Steve");
		c8.setGender("Male");
		c8.setPlanName("Medical");
		c8.setPlanStatus("Denied");
		
		c8.setDenialReason("Diabetic Income");
		
		//Food Data
		CitizenPlan c9=new CitizenPlan();
		c9.setCitizenName("Samantha");
		c9.setGender("Female");
		...
		c10.setCitizenName("Saiteja");
		c10.setGender("Male");
		c10.setPlanName("Employment");
		c10.setPlanStatus("Approved");
		c10.setPlanStartDate(LocalDate.now());
		c10.setPlanEndDate(LocalDate.now().plusMonths(6));
		c10.setBenifitAmount(6000.00);
		...
		c11.setDenialReason("Diabetic Income");
		
		//Food Data
		CitizenPlan c12=new CitizenPlan();
		c12.setCitizenName("Kathy");
